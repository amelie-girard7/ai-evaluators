---
title: Evaluation-Driven Development (EDD) Framework
tags: [evals, ai-products, development-process, synthetic-data, product-quality]
last_updated: 2026-05-01
sources: ["raw/web/Stop Launching AI Apps Without This Framework.md"]
---
...
[Eval Maturity Ladder](../01-Foundations/Eval-Maturity-Ladder.md) emphasizes the importance of structured evaluation. EDD expands on this by providing a concrete process for teams to implement it.
...
```mermaid
graph TD
    A[Minimum Viable Product (MVP)] --> B[Synthetic Query Generation]
    B --> C[Manual Labeling of Outputs]
    C --> D[Build Minimum Viable Evaluation (MVE)]
    D --> E[Run Evaluations]
    E --> F[Iterate on MVP]
    F --> A
```
...
[Mirage of Generic Metrics](../04-Metrics-and-Scoring/Mirage-of-Generic-Metrics.md) explains why generic metrics like BLEU/ROUGE are insufficient. EDD emphasizes task-specific, business-aligned metrics.
...
A minimal evaluation harness can be built with just 20–50 labeled examples, as shown in [build an ai evals dataset from scratch](../02-Building-Evals/build-an-ai-evals-dataset-from-scratch.md).
...
- [Judge Validation Protocol](../03-LLM-Judges/Validation-Protocol.md) for calibrating LLM judges
- [Error Analysis](../05-Error-Analysis/Overview.md) to identify failure modes
