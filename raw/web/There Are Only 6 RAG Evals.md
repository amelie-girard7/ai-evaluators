...
source: https://jxnl.co/writing/2025/05/19/there-are-only-6-rag-evals/
author:
- '[[[''jxnl'']]]'
published: 2025-05-19
created: 2026-04-30
description: There are only 6 fundamental ways to evaluate a RAG system. Here's how
  to do it.
tags:
- clippings
processed: true
...
- *Why It Matters*: This is the primary user experience metric. It's also why we focus on building feedback mechanisms that specifically ask "Did we answer your question?" rather than vague "How did we do?" feedback prompts. Specific feedback matched to this metric increases response rates dramatically.
...
*What's your experience with RAG evaluation? Do you find yourself focusing on particular metrics more than others? Drop a comment below—I'd love to hear which of these 6 relationships causes you the most headaches.*
