...
!["Level 0\nVibe Checks\n(Manual, ad hoc)"](../assets/diagrams/eval-maturity-ladder-1-dcaa250a.png)
---
...
*Back: [Why Evals Matter](why-evals-matter.md) | Next section: [Eval Taxonomy](../foundations/eval-types-overview.md)*
