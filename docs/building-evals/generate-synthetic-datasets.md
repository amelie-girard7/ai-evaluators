...
![Define dimensions](../assets/diagrams/generate-synthetic-datasets-1-f5a313cb.png)
---
...
Use [Human Evals](../foundations/human-evals.md) to build a calibration set and refine your synthetic generation process.
...
- **LLM-as-Judge**: Validate synthetic data with [LLM as Judge Complete Guide](../llm-judges/llm-as-judge-complete-guide.md) to ensure alignment with your evaluation criteria.
- **Human Evals**: Use [Human Evals](../foundations/human-evals.md) to refine synthetic data and ensure quality.
...
**Next: [AI Observability in Production](../lifecycle/observability-in-production.md)**
