...
### Tools for Logging
Use observability/LLMOps platforms like [LLMOps tools](../metrics/mirage-of-generic-metrics.md) to log and search traces. Aim for 50–100 traces initially.
...
![Collect Traces](../assets/diagrams/build-an-ai-evals-dataset-from-scratch-1-461cb91e.png)
---
